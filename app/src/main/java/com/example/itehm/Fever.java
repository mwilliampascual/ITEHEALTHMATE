...
public class Fever extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LeftIcon.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Fever.this, Symptoms.class));
            }
        });
        RightIcon.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Fever.this, MainActivity.class));
            }
        });
    ...
    private void calculatePercentage() {
        int totalSymptoms = 6; // Total number of checkboxes representing symptoms
    ...
    private void showDisclaimerDialog() {
        ...
        builder.setTitle("Disclaimer and References")
                .setMessage("DISCLAIMER: HealthMate's symptom checker is provided for informational purposes only and should not be considered a substitute for professional medical advice, diagnosis, or treatment; always consult a qualified healthcare professional for personalized guidance.\n\n" +
                        "REFERENCES:\n-  Fever. Retrieved from (2023, May 31). https://my.clevelandclinic.org/health/symptoms/10880-fever?fbclid=IwAR1Ke3C9HbGykvHiL33xgqXPgumRsLZrfR_-i5MUKmCAZJ0sAUquHmADmaw\n"  + "\n" + "Youtube Reference:" + "\n"+"https://youtu.be/r4cFT9_kZIc")
