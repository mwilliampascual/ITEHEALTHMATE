...
public class Choking extends AppCompatActivity {
    ...
    private static final String YOUTUBE_VIDEO_URL = "https://youtu.be/O2ja8MNdQuQ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RightIcon.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Choking.this, MainActivity.class));
            }
        });
        ...
        videoView.setVideoPath("android.resource://" + getPackageName() + "/" + R.raw.choking);
