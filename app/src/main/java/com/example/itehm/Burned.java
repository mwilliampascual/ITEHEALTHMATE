...
public class Burned extends AppCompatActivity {

    private static final String YOUTUBE_VIDEO_URL = "https://youtu.be/z_5tuB1YMK0";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_burned);
        ...
        LeftIcon.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Burned.this, FirstAid.class));
            }
        });
        RightIcon.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Burned.this, MainActivity.class));
            }
        });
        ...
        videoView.setVideoPath("android.resource://" + getPackageName() + "/" + R.raw.burned);
